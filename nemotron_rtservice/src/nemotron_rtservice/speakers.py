...
def speaker_turns(text: str, words: tuple[SpeakerWord, ...], start_s: float,
    ...
    for index in range(1, len(words) + 1):
        ...
        # RNNT trailing words may start/end beyond the consumed-audio
        # boundary. Preserve their text and slot when the turn starts inside
        # real audio, then clip the turn. A wholly out-of-range turn fails below.
